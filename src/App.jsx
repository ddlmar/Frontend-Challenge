      ...
      <div >
        ...
        <BrowserRouter>
            ...
            <div className = {styles.appContainer}>
              <div className = {styles.introAdArea}>
                <div className = {styles.quoteArea}>
                  <h1 className = {styles.quoteTitle}>Easily create or join a local<br></br> nanny share with Hapu</h1>
                  <p className = {styles.quoteStyle}>Hapu is Airbnb for nanny share. Share your home, nanny and costs <br />
          ...
          <section className = {classnames(styles.appContainer, styles.memberNannyArea)}>
            ...
            <p>
              <b className = {styles.linkStyle}>Sarah’s day care available now in North Sydney </b>
              <b>Wednesday, Thursday, Friday - 7:30 - 5:30</b> 
            </p>
          </section>
          <section className = {styles.bgGeneral}>
            ...
            <div className = {styles.nannyMap}>
              <img src={NannyMap} alt="location where nannies are on the map" />
            </div>
            </div>
          ...
          <section className = {styles.bgGeneral}>
            <div className = {classnames(styles.appContainer, styles.emailSection)}>
              ...
              <div className ={styles.registrationArea}></div>
            </div>
          <hr className = {styles.separatorSection}/>      
          </section>         
          <section className = {styles.bgGeneral}>
            <div className = {classnames(styles.appContainer, styles.budgetArea)}>
              ...
              <div>
                <h1 className = {styles.titleStyle}>Shared payments made simple</h1>
                ...
                <span className = {styles.linkStyle}>Read how Bridget’s share (without Hapu) ended over $15</span>
              </div>
            </div>
          <hr className = {styles.separatorSection}/>
          </section>
          <section className = {styles.bgGeneral}>
            <div className = {classnames(styles.appContainer, styles.operationArea)}>
              <h1 className = {styles.titleStyle}>A framework built for the long term</h1>
              ...
              <span className = {styles.linkStyle}>Read how Hapu’s tribal background defines our app </span>
          ...
          <section className = {styles.bgGeneral} >
            <div className = {classnames(styles.appContainer, styles.newsSectionArea)}>
              ...
              <p className = {styles.operationP}>With the Hapu daily diary your nanny will be able to update you and your 
