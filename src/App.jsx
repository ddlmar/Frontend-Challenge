            ...
            <section className = {classnames(styles.introBG)}>  
              <div className = {styles.appContainer}>
                <div className = {styles.introAdArea}>
                  <Experiment name='heroSection'>
                    <Variant name='joinLocal'>
                    ...
                    <Variant name='priceLocal'> 
                      <div className = {styles.quoteArea}>
                        <h1 className = {styles.quoteTitle}>Create the childcare you need at a price you can afford</h1>
                        <p className = {styles.quoteStyle}>Connect with other local families to share a nanny from 
                        as low as $10.00/hr each. Create your family profile today to get started.</p>    
                        <div className = {styles.buttonArea}>
                          <button className = {styles.buttonStyle}></button>
                          <p className = {styles.buttonPhrase}>See hapu in action (27 seconds)</p>
                        </div>
              ...
              <div className = {classnames(styles.appContainer, styles.fetchNannyArea)}>
                <div className = {styles.serviceExempleArea}>
                  ...
                  <p className = {styles.pStyle}>You have a fantastic home, a fantastic 
                    ...
                    <Link to='' className = {styles.linkStyle}>Ready to get started?</Link>
                </div>
